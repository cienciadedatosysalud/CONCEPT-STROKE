...
```{r, echo = FALSE, warning = FALSE, out.width = "1920px",  out.height = "980px", fig.cap="Inductive miner with only filtered traces"}
...
##### Decision mining with points (petri net)
:::{.scrolling}

```{r, echo = FALSE, warning = FALSE,out.width = "1920px",  out.height = "980px", fig.cap="Petri net with points for decision mining"}
...
```
:::
##### Decision mining with activities (petri net)
:::{.scrolling}
```{r, echo = FALSE, warning = FALSE, out.width = "1920px",  out.height = "980px", fig.cap="Petri net with activities for decision mining"}
